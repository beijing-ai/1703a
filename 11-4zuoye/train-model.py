...
class Train(object):
    def __init__(self,yolo,data):
        ...
        self.saver_iter = cfg.SUMMARY_ITER
        ...
        with tf.control_dependencies([self.optimizer]):
            ...
            print('Restore weight from',weight_file)
            self.saver.restore(self.sess,weight_file)
            self.writer.add_graph(self.sess)
        ...
        for step in xrange(0,self.max_step + 1):
            ...
            if step % self.summary_iter == 0:
                if step % 50 == 0:
                    ...
                    for i in range(num):
                        image_t,label_t = self.data.next_batches_test(labels_test)
                        feed_dict_t = {self.yolo.images:image_t,self.yolo.labels:label_t}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight',default='yolo_v2.ckpt',type=str)
